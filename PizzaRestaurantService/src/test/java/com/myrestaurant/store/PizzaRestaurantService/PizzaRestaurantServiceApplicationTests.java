...
class PizzaRestaurantServiceApplicationTests {
    ...
    @Test
    void populateDB() {
        /*Topping mozzarella = new Topping(parametri); senza il pattern @Builder*/
        /*@Builder nel model ti permette di passare solo i parametri che ci interessano*/
        /*Hibernate inserisce automaticamente i Topping quando non li trova nel momento in cui inserisce la pizza*/
        ...
        Restaurant vogliaDiPizza = Restaurant
                .builder()
        ...
        Restaurant pizzaAGoGo = Restaurant
                .builder()
                .name("Pizza a GoGo")
                .address("Via Milano")
                .city("Milano")
                .drivers(Set.of(driver4, driver5, driver6))
                .build();
